...
// エフェクト生成
//=============================================================================
void CAttackArcher::CreateEffect(D3DXVECTOR3 pos, ATTACK_STATE state)
{
	//プレイヤーのポインタ
	...
	GET_COLORMANAGER->GetStepColor(pPlaryer->GetColorNumber(), pPlaryer->GetChargeTilelevel() + 1), ARCHER_EFFECT_LIFE , CSkill_effect::SKILLTYPE_KNIGHT, GetPlayer());
