...
const std::string CResourceTexture::m_aTexPath[CResourceTexture::TEXTURE_MAX]
{
	...
	"./data/Textures/attack_area/all_lv1_attack.png",                  // 攻撃範囲*全キャラレベル1
	"./data/Textures/attack_area/00_knight/knight_lv2_attack.png",     // 攻撃範囲*騎士レベル2
	"./data/Textures/attack_area/00_knight/knight_lv3_attack.png",     // 攻撃範囲*騎士レベル3
	"./data/Textures/attack_area/01_lancer/lancer_lv2_attack.png",     // 攻撃範囲*槍レベル2
	"./data/Textures/attack_area/01_lancer/lancer_lv3_attack.png",     // 攻撃範囲*槍レベル3
	"./data/Textures/attack_area/02_wizard/wizard_lv2_attack.png",     // 攻撃範囲*魔法レベル2
	"./data/Textures/attack_area/02_wizard/wizard_lv3_attack.png",     // 攻撃範囲*魔法レベル3
	"./data/Textures/attack_area/03_thief/thief_lv2_attack.png",       // 攻撃範囲*盗賊レベル2
	"./data/Textures/attack_area/03_thief/thief_lv3_attack.png",       // 攻撃範囲*盗賊レベル3
	"./data/Textures/attack_area/04_magician/magician_lv2_attack.png", // 攻撃範囲*奇術師レベル2
	"./data/Textures/attack_area/04_magician/magician_lv3_attack.png", // 攻撃範囲*奇術師レベル3
	"./data/Textures/attack_area/05_archer/archer_lv2_attack.png",     // 攻撃範囲*弓レベル2
	"./data/Textures/attack_area/05_archer/archer_lv3_attack.png",     // 攻撃範囲*弓レベル3
};
